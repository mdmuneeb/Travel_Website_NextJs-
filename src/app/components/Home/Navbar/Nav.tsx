  ...
  return (
    <div className={` ${navBg?"bg-blue-950 shadow-md": "fixed"} transition-all duration-200 h-[12vh] z-[1000] fixed w-full`}>
      <div className='flex items-center justify-between h-full w-[90%] xl:w-[80%] mx-auto'>
        ...
        <div className='hidden lg:flex items-center space-x-10 '>
            {
                navLinks.map((link) => {
                    ...
                    <p className="relative text-white text-base font-medium w-fit block 
                        ...
                        after:w-full after:scale-x-0 after:-bottom-1 after:left-0 
        ...
        <div className='flex items-center space-x-4'><button className='md:px-12 md:py-2.5 px-8 py-2 text-black text-base bg-white hover:bg-gray-200 transition duration-200 rounded-lg'>Book Now</button>
