    ...
    <div className='pt-16 pb-16 '>
        <div className='w-[80%] mx-auto items-start grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10'>
            <div className='space-y-5'>
                ...
                <p className='text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950'>Magizine</p>
            </div>
            <div className='space-y-5'>
            ...
            <div className='space-y-5'>
                ...
                <div className='mt-6 '>
                    ...
                    <h1 className='text-base font-bold text-blue-950 mt-1 '>+0123 345 6788</h1>
                </div>
                <div className='mt-6 '>
                    <h1 className='text-sm text-gray-600'>Our Email</h1>
                    <h1 className='text-base font-bold text-blue-950 mt-1 '>abcd@gmail.com</h1>
                </div>
            </div>
        </div>
